...
export * from './lib/modules/svgpath/svgpath.module';
export * from './lib/modules/svgpolygon/svgpolygon.module';
export * from './lib/modules/svgpolyline/svgpolyline.module';
export * from './lib/modules/svgrect/svgrect.module';
export * from './lib/modules/svgtext/svgtext.module';
export * from './lib/types/circle.model';
export * from './lib/types/ellipse.model';
export * from './lib/types/path.model';
export * from './lib/types/polygon.model';
export * from './lib/types/elementclick-event.model';
export * from './lib/types/line.model';
export * from './lib/types/polyline.model';
export * from './lib/types/rectangle.model';
export * from './lib/types/stroke.model';
export * from './lib/types/textfont.model';
export * from './lib/types/vertex.model';
